                        ...
                        <table className="table table-responsive table-bordered table-striped dataTable dtr-inline">
                          <thead>
                            <tr role="row" className="text-center">
                              ...
                              <th className="sorting">Origin Operation Id</th>
                                ...
                                >
                                  <div data-v-23e5cb30="" data-v-5190bedc="">
                                    ...
                                    <svg
                                      ...
                                      aria-labelledby="svg-inline--fa-title-okO1vwAxpAqN"
                                      data-prefix="fa"
                                      ...
                                      data-fa-i2svg=""
                                    >
                                      <title id="svg-inline--fa-title-okO1vwAxpAqN">
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <svg
                                      ...
                                      aria-labelledby="svg-inline--fa-title-Ed2ZHLPZjEnX"
                                      data-prefix="fa"
                                      data-icon="question-circle"
                                      role="img"
                                      xmlns="http://www.w3.org/2000/svg"
                                      ...
                                      data-fa-i2svg=""
                                    >
                                      <title id="svg-inline--fa-title-Ed2ZHLPZjEnX">
