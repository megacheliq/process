              ...
              <div id="app">
                <div className="card card-primary card-tabs">
                  ...
                  <div className="card-body">
                    <div className="row mb-2">
                      <div className="col">
                        <div className="btn-toolbar float-right">
                          ...
                          <div className="btn-group mr-2">
                            <div data-v-268d7a58="" className="settings">
                              <div data-v-268d7a58="" className="table-settings">
                                <div
                                  data-v-268d7a58=""
                                  className="table-settings__name"
                                >
                                  <svg
                                    data-v-268d7a58=""
                                  ...
                                  {/* <i data-v-268d7a58="" class="fa fa-cog"></i> Font Awesome fontawesome.com */}{" "}
                                  Table settings{" "}
                                  <svg
                                    data-v-268d7a58=""
                                  ...
                                  {/* <i data-v-268d7a58="" class="fa fa-chevron-down"></i> Font Awesome fontawesome.com */}
                                </div>{" "}
                                <div
                                  data-v-268d7a58=""
                                  className="table-settings__items"
                                  style={{ display: "none" }}
                                >
                                  <div
                                    data-v-268d7a58=""
                                  ...
                                  <div data-v-268d7a58="" className="multiselect">
                                    <label
                                      data-v-268d7a58=""
                                      htmlFor="option.key"
                                    ...
                                    >
                                      <input
                                        ...
                                        defaultValue="[object Object]"
                                      />{" "}
                                      <span data-v-268d7a58="">Customer Bank</span>
                                    </label>
                                    <label
                                      data-v-268d7a58=""
                                      htmlFor="option.key"
                                    ...
                                    >
                                      <input
                                        ...
                                        defaultValue="[object Object]"
                                      />{" "}
                                      <span data-v-268d7a58="">Branch Name</span>
                                    </label>
                                    <label
                                      data-v-268d7a58=""
                                      htmlFor="option.key"
                                    ...
                                    >
                                      <input
                                        ...
                                        defaultValue="[object Object]"
                                      />{" "}
                                      <span data-v-268d7a58="">Receipt</span>
                                    </label>
                                    <label
                                      data-v-268d7a58=""
                                      htmlFor="option.key"
                                    ...
                                    >
                                      <input
                                        ...
                                        defaultValue="[object Object]"
                                      />{" "}
                                      <span data-v-268d7a58="">Created At</span>
                                    </label>
                                    <label
                                      data-v-268d7a58=""
                                      htmlFor="option.key"
                          ...
                          <div className="btn-group mr-2">
                            <button
                              data-target="#download-csv-modal"
                              data-toggle="modal"
                            ...
                            >
                              ...
                              {/* <i class="fa fa-download"></i> Font Awesome fontawesome.com */}{" "}
                              CSV
                            </button>{" "}
                            <div
                              data-v-5190bedc=""
                              id="download-csv-modal"
                                      ...
                                      <div data-v-5190bedc="" className="row">
                                        <div data-v-5190bedc="" className="col-6">
                                          ...
                                          >
                                            ...
                                            <input
                                              data-v-5190bedc=""
                                              id="createdAt-csv-filter-daterange-btn"
                                              className="form-control"
                                            />
                                          </div>
                                        </div>{" "}
                            ...
                            <div className="input-group">
                              <div className="input-group-prepend">
                                ...
                                >
                                  ...
                                  {/* <i class="fa fa-sync"></i> Font Awesome fontawesome.com */}
                                </button>
                              </div>{" "}
                        ...
                        <table className="table table-responsive table-bordered table-striped dataTable dtr-inline">
                          <thead>
                            <tr role="row" className="text-center">
                              <th className="sorting">Operation Id</th>
                              <th className="sorting">Payment Method</th>
                              <th className="sorting">Account Group</th>
                              <th className="sorting">Partner Account</th>
                              <th className="sorting">Customer Bank</th>
                              <th className="sorting">Customer Account Name</th>
                              <th className="sorting">Customer Account</th>
                              <th className="sorting">Branch Name</th>
                              <th className="sorting">Amount</th>
                              <th className="sorting">Currency</th>
                              <th className="sorting">Status</th>
                              <th className="sorting">Receipt</th>
                              <th className="sorting">Operator</th>
                              <th className="sorting">Actions</th>
                              <th className="sorting sorting_desc">Created At</th>
                              <th className="sorting">Updated At</th>
                            </tr>
                          </thead>{" "}
                          <tbody>
                            <tr>
                              ...
                              <td className="text-center">
                                <div className="form-group">
                                  ...
                                  <div
                                    dir="auto"
                                    className="v-select under-tab vs--single vs--searchable"
                                  >
                                    {" "}
                                    <div
                                      id="vs2__combobox"
                              ...
                              <td className="text-center">
                                <div className="form-group">
                                  {/**/}{" "}
                                  <input
                                    placeholder="customerAccountName"
                                    type="text"
                                    className="form-control"
                                  />
                                </div>
                              ...
                              <td className="text-center">
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {/* <i class="far fa-calendar-alt"></i> Font Awesome fontawesome.com */}{" "}
                                    <svg
                                    ...
                                    {/* <i class="fas fa-caret-down"></i> Font Awesome fontawesome.com */}{" "}
                                    <span />
                                  </button>
                                </div>
                              </td>
                            ...
                            <div data-v-5190bedc="" className="modal-content">
                              ...
                              <div data-v-5190bedc="" className="modal-body">
                                <div
                                  ...
                                  style={{ display: "none" }}
                                >
                                  <div data-v-23e5cb30="" data-v-5190bedc="">
                                    {/**/}{" "}
                                    <label
                                      data-v-23e5cb30=""
                                      data-v-5190bedc=""
                                      htmlFor="originAmountMajor"
                                      className="required"
                                    >
                                    ...
                                    <svg
                                      ...
                                      aria-labelledby="svg-inline--fa-title-lEwsxDflF1Fk"
                                      data-prefix="fa"
                                      ...
                                      data-fa-i2svg=""
                                    >
                                      <title id="svg-inline--fa-title-lEwsxDflF1Fk">
                                    ...
                                    {/* <i data-v-23e5cb30="" data-v-5190bedc="" title="Amount must be a number greater than zero" data-toggle="tooltip" class="fa fa-question-circle"></i> Font Awesome fontawesome.com */}{" "}
                                    <input
                                      data-v-23e5cb30=""
                                      type="tel"
                                      className="v-money form-control"
                                      id="originAmountMajor"
                                      name="originAmountMajor"
                                      data-v-5190bedc=""
                                    />
                                  </div>{" "}
                                  <div
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <svg
                                      ...
                                      data-v-5190bedc=""
                                      data-toggle="tooltip"
                                      className="svg-inline--fa fa-question-circle fa-w-16 ml-1 mr-1"
                                      aria-labelledby="svg-inline--fa-title-eJqX54nGUoo4"
                                      data-prefix="fa"
                                      data-icon="question-circle"
                                      role="img"
                                      xmlns="http://www.w3.org/2000/svg"
                                      ...
                                      data-fa-i2svg=""
                                    >
                                      <title id="svg-inline--fa-title-eJqX54nGUoo4">
                                    ...
                                    {/* <i data-v-23e5cb30="" data-v-5190bedc="" title="Available file formats: " data-toggle="tooltip" class="fa fa-question-circle ml-1 mr-1"></i> Font Awesome fontawesome.com */}{" "}
                                    <input
                                      data-v-23e5cb30=""
                                      data-v-5190bedc=""
                                      id="slip"
                    ...
                    <div data-v-1fd0e0fc="" operation-settings="[object Object]">
                      <div
                        data-v-1fd0e0fc=""
                        className="col d-sm-flex justify-content-sm-center"
                      >
                    ...
                    <div data-v-afd1f21a="">
                      ...
                      >
                        <div
                          data-v-5190bedc=""
                          data-v-afd1f21a=""
                          id="set-converted-amount-dialog"
                          data-backdrop="static"
                          data-keyboard="false"
                          className="modal fade"
                        >
