import { CreateGroupDto, Currency, LimitType, OperationType, PaymentMethod, Period } from "@/root/types";
import { zodResolver } from "@hookform/resolvers/zod";
import { useFieldArray, useForm } from "react-hook-form";
import { z } from "zod";
import { Button, Form, InputGroup } from "react-bootstrap";
import { useRef } from "react";
import { addGroup } from "@/root/endpoints";
...
const AccountGroupForm: React.FC = () => {
    ...
    const { register, handleSubmit, control, formState: { errors } } = useForm<GroupFormInputs>({
