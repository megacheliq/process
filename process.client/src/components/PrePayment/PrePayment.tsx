                                  ...
                                  <div data-v-268d7a58="" className="multiselect">
                                    ...
                                    >
                                      <input
                                        ...
                                        defaultValue="[object Object]"
                                      />{" "}
                                      <span data-v-268d7a58="">Origin Amount</span>
                                    </label>
                                    <label
                                      data-v-268d7a58=""
                                      htmlFor="option.key"
                        ...
                        <table className="table table-responsive table-bordered table-striped dataTable dtr-inline">
                          <thead>
                            <tr role="row" className="text-center">
                              ...
                              <th className="sorting">Origin Amount</th>
                              <th className="sorting">Amount</th>
                              <th className="sorting">Currency</th>
                              <th className="sorting">Status</th>
                              <th className="sorting">Identification Info</th>
                            ...
                            <tr>
                              ...
                              <td className="text-center">
                                <div className="form-group">
                                  {/**/}{" "}
                                  <input
                                    placeholder="identificationInfo"
                                    type="text"
                                    className="form-control"
                                  />
                                </div>
                                ...
                                >
                                  <div data-v-23e5cb30="" data-v-5190bedc="">
                                    ...
                                    <svg
                                      ...
                                      aria-labelledby="svg-inline--fa-title-xr8534k6uXmb"
                                      data-prefix="fa"
                                      ...
                                      data-fa-i2svg=""
                                    >
                                      <title id="svg-inline--fa-title-xr8534k6uXmb">
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <svg
                                      ...
                                      aria-labelledby="svg-inline--fa-title-RWuI1X1IPuxv"
                                      data-prefix="fa"
                                      data-icon="question-circle"
                                      role="img"
                                      xmlns="http://www.w3.org/2000/svg"
                                      ...
                                      data-fa-i2svg=""
                                    >
                                      <title id="svg-inline--fa-title-RWuI1X1IPuxv">
